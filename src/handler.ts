/**
 * mc-payment-demo - Lambda Handler
 * Team: platform-team
 *
...
// Configuration
// ============================================================
const TABLE_NAME = process.env.TABLE_NAME || 'mc-payment-demo-table';
...
function createResponse(statusCode: number, body: unknown): ApiResponse {
  return {
    statusCode,
    body: JSON.stringify({
      service: 'mc-payment-demo',
      timestamp: new Date().toISOString(),
      ...( typeof body === 'object' ? body : { message: body }),
    }),
    headers: {
      'Content-Type': 'application/json',
      'X-Service-Name': 'mc-payment-demo',
      'X-Service-Team': 'platform-team',
